...
import { getProducts, IS_DEMO } from "@/lib/api";
...
const MOCK_POSTS: ScheduledPost[] = IS_DEMO ? [
  {
    id: "sp1",
    jobId: "j1",
...
const MOCK_AB_TEST: ABTest | null = IS_DEMO ? {
  id: "ab1",
  productId: "1",
  variants: [
          ...
          <Card>
            ...
            <CardContent>
              {MOCK_AB_TEST ? (
                ...
                <p className="text-sm text-muted-foreground">{t("abTestPending")}</p>
              )}
            </CardContent>
          </Card>
        </div>
